...
var authRequest = exports.authRequest = function* authRequest(url, options) {
  var token = yield (0, _effects.select)(function (state) {
  ...
  return yield (0, _effects.call)(request, url, _extends({}, options, {
    headers: headers
  }));
};
