...
var createSagaPlaceholder = function createSagaPlaceholder(schema, actionName) {
  return _regenerator2.default.mark(function _callee(data) {
...
var buildSagas = exports.buildSagas = function buildSagas(schema) {
  var _marked = [watchLoadFlow, watchInsertFlow, watchUpdateFlow, watchDeleteFlow, watchInsertAllFlow, watchUpdateAllFlow, watchDeleteAllFlow].map(_regenerator2.default.mark);

  function watchLoadFlow() {
    var flow;
    return _regenerator2.default.wrap(function watchLoadFlow$(_context2) {
      while (1) {
  ...
  function watchInsertFlow() {
    var flow;
    return _regenerator2.default.wrap(function watchInsertFlow$(_context3) {
      while (1) {
  ...
  function watchUpdateFlow() {
    var flow;
    return _regenerator2.default.wrap(function watchUpdateFlow$(_context4) {
      while (1) {
  ...
  function watchDeleteFlow() {
    var flow;
    return _regenerator2.default.wrap(function watchDeleteFlow$(_context5) {
      while (1) {
  ...
  function watchInsertAllFlow() {
    var flow;
    return _regenerator2.default.wrap(function watchInsertAllFlow$(_context6) {
      while (1) {
  ...
  function watchUpdateAllFlow() {
    var flow;
    return _regenerator2.default.wrap(function watchUpdateAllFlow$(_context7) {
      while (1) {
  ...
  function watchDeleteAllFlow() {
    var flow;
    return _regenerator2.default.wrap(function watchDeleteAllFlow$(_context8) {
      while (1) {
