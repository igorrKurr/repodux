...
var Resource = exports.Resource = function Resource() {
  ...
  this.select = function (f, name) {
    var selector = (0, _reselect.createSelector)([baseSelector], f);
    _this.selectors[name] = selector;
    return selector;
  };

  this.link = function (s, f, name) {
    var selector = (0, _reselect.createSelector)(s, f);
    _this.selectors[name] = selector;
    return selector;
  };
