...
var ACTION_HANDLERS = (0, _defineProperty3.default)({}, _constants.REHYDRATE, function (state, _ref) {
...
var config = {
  ...
  transforms: [_immutable2.default],
...
var buildStore = exports.buildStore = function buildStore(resources, _ref2) {
  ...
  var rootReducer = (0, _redux.combineReducers)(_assign2.default.apply(Object, [{}, storeReducer].concat((0, _toConsumableArray3.default)(reducers))));
  var rootSaga = _regenerator2.default.mark(function root() {
    ...
    return _regenerator2.default.wrap(function root$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return (0, _effects.all)((_Array$prototype = Array.prototype).concat.apply(_Array$prototype, (0, _toConsumableArray3.default)(sagas)).map(_effects.fork));
