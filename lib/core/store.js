...
exports.buildStore = exports.rehydratedSelector = exports.INITIAL_STATE = undefined;
...
var buildStore = exports.buildStore = function buildStore(resources) {
  ...
  var resourceTransforms = (0, _persist.createTransform)(resources.map(function (r) {
    return r.name;
  }));
  var config = {
    storage: _localforage2.default,
    transforms: [_immutable.immutableTransform, resourceTransforms],
    blacklist: ['rehydration'],
    keyPrefix: 'repodux:',
    debounce: 300
  };

  var storePersist = function storePersist(store) {
  ...
  var rootReducer = (0, _redux.combineReducers)(Object.assign.apply(Object, [{}, { rehydration: storeReducer }].concat(_toConsumableArray(reducers))));
  var rootSaga = function* root() {
    var _Array$prototype;

    yield (0, _effects.all)((_Array$prototype = Array.prototype).concat.apply(_Array$prototype, _toConsumableArray(sagas)).map(_effects.fork));
  };
  ...
  if (logger) {
    var _logger = (0, _reduxLogger.createLogger)({});
