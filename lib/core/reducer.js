...
var buildReducer = exports.buildReducer = function buildReducer(types, id) {
  ...
  }), _defineProperty(_handlers, types.load.failure, function (state) {
    return state.set('loading', false);
  }), _defineProperty(_handlers, types.update.tap, function (state) {
    return state.set('updating', true);
  }), _defineProperty(_handlers, types.update.success, function (state, _ref3) {
    var payload = _ref3.payload;

    return state.updateIn(['items', payload[id]], function (item) {
      return item.merge(payload);
    }).set('updating', false);
  }), _defineProperty(_handlers, types.update.failure, function (state, _ref4) {
    var payload = _ref4.payload;

    return state.set('updating', true);
  }), _defineProperty(_handlers, types.updateAll.tap, function (state) {
    return state.set('updating', true);
  }), _defineProperty(_handlers, types.updateAll.success, function (state, _ref5) {
    var payload = _ref5.payload;

    return state.update('items', function (items) {
      return items.merge(payload);
    }).set('updating', false);
  }), _defineProperty(_handlers, types.updateAll.failure, function (state, _ref6) {
  ...
  }), _defineProperty(_handlers, types.insert.success, function (state, _ref7) {
    var payload = _ref7.payload;

    return state.setIn(['items', payload[id]], payload).set('inserting', false);
  }), _defineProperty(_handlers, types.insert.failure, function (state) {
    return state.set('inserting', false);
  }), _defineProperty(_handlers, types.insertAll.tap, function (state) {
    return state.set('inserting', true);
  }), _defineProperty(_handlers, types.insertAll.success, function (state, _ref8) {
    var payload = _ref8.payload;

    return state.update('items', function (items) {
      return items.merge(payload);
    }).set('inserting', false);
  }), _defineProperty(_handlers, types.insertAll.failure, function (state) {
    return state.set('inserting', false);
  }), _defineProperty(_handlers, types.delete.tap, function (state) {
    return state.set('deleting', true);
  }), _defineProperty(_handlers, types.delete.success, function (state, _ref9) {
    var payload = _ref9.payload;

    return state.update('items', function (items) {
      return items.without(payload[id]);
    }).set('deleting', false);
  }), _defineProperty(_handlers, types.delete.failure, function (state, _ref10) {
    var payload = _ref10.payload;

    return state.set('deleting', false);
  }), _defineProperty(_handlers, types.deleteAll.tap, function (state) {
    return state.set('deleting', true);
  }), _defineProperty(_handlers, types.deleteAll.success, function (state, _ref11) {
  ...
  }), _defineProperty(_handlers, types.deleteAll.failure, function (state, _ref12) {
